...
# Create an agent
learner = QAgent.QLearningAgent(env=env, epsilon=0.05, gamma=0.8, alpha=0.0003,
                                weights=np.zeros(7),
                                # [-4.97775705, 1.27415361, 0.24966353, 23.9207037, -19.98592583, 4.61179327, 8.13939487],
                                features=[angleVariance, edgeVariance,
                                          distanceToAllUnconnectedNodesWithinBall, closestUnconnectedNode,
                                          distToFarthestConnectedNode, distToClosestConnectedNode,
                                          biasFunc])
